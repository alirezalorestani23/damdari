...
//Week_Of_Month
    ...
    companion object {
        ...
        fun jalaliToGregorian(jalali: YearMonthDate): YearMonthDate {
            ...
            jalaliDayNo =
                365 * jalali.year + (jalali.year / 33) * 8 + Math.floor((jalali.year % 33 + 3) / 4.toDouble()).toInt()
            i = 0
            ...
            gregorianYear =
                1600 + 400 * Math.floor(gregorianDayNo / 146097.toDouble()).toInt() /* 146097 = 365*400 + 400/4 - 400/100 + 400/400 */
        ...
        fun isLeepYear(year: Int): Boolean { //Algorithm from www.wikipedia.com
